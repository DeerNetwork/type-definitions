...
declare module '@polkadot/types/lookup' {
  ...
  /** @name PalletStorageStoreFile (479) */
  ...
  /** @name PalletStorageFileOrder (480) */
  ...
  /** @name PalletStorageReleases (481) */
