...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    ...
    fileStorage: {
       ...
       **/
      forceDelete: AugmentedSubmittable<(cid: FileId | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [FileId]>;
      /**
       * Register a node
       **/
      register: AugmentedSubmittable<(machineId: MachineId | string | Uint8Array, iasCert: Bytes | string | Uint8Array, iasSig: Bytes | string | Uint8Array, iasBody: Bytes | string | Uint8Array, sig: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MachineId, Bytes, Bytes, Bytes, Bytes]>;
      /**
       * Report storage work.
       **/
       ...
       **/
      setEnclave: AugmentedSubmittable<(enclave: EnclaveId | string | Uint8Array, expire: BlockNumber | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [EnclaveId, BlockNumber]>;
      /**
       * Stash a account so it can be used for a storage node, the amount of funds to stash is T::StashBalance
       **/
      stash: AugmentedSubmittable<(node: LookupSource | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [LookupSource]>;
      /**
       * Add file to storage
       **/
      store: AugmentedSubmittable<(cid: FileId | string | Uint8Array, fileSize: u64 | AnyNumber | Uint8Array, fee: BalanceOf | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [FileId, u64, BalanceOf]>;
      /**
    ...
    nft: {
       ...
       * Weight: `O(1)`
       **/
      acceptTransfer: AugmentedSubmittable<(clazz: Compact<ClassId> | AnyNumber | Uint8Array, instance: Compact<InstanceId> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<ClassId>, Compact<InstanceId>]>;
      /**
       ...
       **/
      burn: AugmentedSubmittable<(clazz: Compact<ClassId> | AnyNumber | Uint8Array, instance: Compact<InstanceId> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<ClassId>, Compact<InstanceId>]>;
      /**
       * Cancel transfer
       * 
       * Arguments:
       ...
       * Weight: `O(1)`
       **/
      cancelTransfer: AugmentedSubmittable<(clazz: Compact<ClassId> | AnyNumber | Uint8Array, instance: Compact<InstanceId> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<ClassId>, Compact<InstanceId>]>;
      /**
       ...
       * Weight: `O(1)`
       **/
      readyTransfer: AugmentedSubmittable<(clazz: Compact<ClassId> | AnyNumber | Uint8Array, instance: Compact<InstanceId> | AnyNumber | Uint8Array, dest: LookupSource | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<ClassId>, Compact<InstanceId>, LookupSource]>;
      /**
    ...
    nftOrder: {
       ...
       **/
      deal: AugmentedSubmittable<(clazz: Compact<ClassId> | AnyNumber | Uint8Array, instance: Compact<InstanceId> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<ClassId>, Compact<InstanceId>]>;
      /**
       * Remove an order
       **/
      remove: AugmentedSubmittable<(clazz: Compact<ClassId> | AnyNumber | Uint8Array, instance: Compact<InstanceId> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<ClassId>, Compact<InstanceId>]>;
      /**
       * Create a order to sell a non-fungible asset
       **/
      sell: AugmentedSubmittable<(clazz: Compact<ClassId> | AnyNumber | Uint8Array, instance: Compact<InstanceId> | AnyNumber | Uint8Array, price: Compact<BalanceOf> | AnyNumber | Uint8Array, deadline: Option<BlockNumber> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<ClassId>, Compact<InstanceId>, Compact<BalanceOf>, Option<BlockNumber>]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
