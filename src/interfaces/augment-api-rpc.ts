...
import type { NodeDepositInfo, StoreFeeInfo } from './fileStorage';
import type { BalanceInfo } from './nft';
...
declare module '@polkadot/rpc-core/types/jsonrpc' {
  export interface RpcInterface {
    ...
    fileStorage: {
       ...
       * Get node deposit.
       **/
      nodeDeposit: AugmentedRpc<(controller: AccountId | string | Uint8Array) => Observable<NodeDepositInfo>>;
      /**
       * Get fee for store ipfs file.
       **/
      storeFee: AugmentedRpc<(fileSize: u64 | AnyNumber | Uint8Array, time: BlockNumber | AnyNumber | Uint8Array) => Observable<StoreFeeInfo>>;
    };
    grandpa: {
      /**
    ...
    nft: {
       ...
       **/
      createClassDeposit: AugmentedRpc<(bytesLen: u32 | AnyNumber | Uint8Array) => Observable<BalanceInfo>>;
      /**
       * Get deposit for mint nft token
       **/
      mintTokenDeposit: AugmentedRpc<(bytesLen: u32 | AnyNumber | Uint8Array) => Observable<BalanceInfo>>;
    };
    offchain: {
      /**
